# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-02-27 01:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='address', to='login_app.Location')),
            ],
        ),
        migrations.AddField(
            model_name='rating',
        ...
        migrations.AddField(
            model_name='match',
            name='user',
            field=models.ManyToManyField(related_name='matches', to='login_app.User'),
        ),
        migrations.AddField(
            model_name='chatroom',
            name='users',
